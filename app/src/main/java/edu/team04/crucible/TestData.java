...
public class TestData implements Runnable{
    ...
    public void run() {
        ...
        category1.addCard(new Card("cat2question1", "cat2answer1"));
        category1.addCard(new Card("cat2question2", "cat2answer2"));
        category1.addCard(new Card("cat2question3", "cat2answer3"));
        category1.addCard(new Card("cat2question4", "cat2answer4"));

        Category category3 = new Category("Category 3");
        category1.addCard(new Card("cat3question1", "cat3answer1"));
        category1.addCard(new Card("cat3question2", "cat3answer2"));
        category1.addCard(new Card("cat3question3", "cat3answer3"));
        category1.addCard(new Card("cat3question4", "cat3answer4"));
        category1.addCard(new Card("cat3question5", "cat3answer5"));
        category1.addCard(new Card("cat3question6", "cat3answer6"));
        category1.addCard(new Card("cat3question7", "cat3answer7"));
        category1.addCard(new Card("cat3question8", "cat3answer8"));

        Category category4 = new Category("Category 4");
        category1.addCard(new Card("cat4question1", "cat4answer1"));
        category1.addCard(new Card("cat4question2", "cat4answer2"));
        category1.addCard(new Card("cat4question3", "cat4answer3"));
        category1.addCard(new Card("cat4question4", "cat4answer4"));
        category1.addCard(new Card("cat4question5", "cat4answer5"));
        category1.addCard(new Card("cat4question6", "cat4answer6"));
